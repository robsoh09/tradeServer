...
export declare type SourceType = 'bitgo' | 'backup' | 'user' | 'cold';
export declare type WebauthnFmt = 'none' | 'packed' | 'fido-u2f';
...
export declare type OptionalKeychainEncryptedKey = Pick<Keychain, 'encryptedPrv' | 'webauthnDevices'>;
export declare type KeychainWithEncryptedPrv = Omit<Keychain, 'encryptedPrv'> & {
    encryptedPrv: string;
};
