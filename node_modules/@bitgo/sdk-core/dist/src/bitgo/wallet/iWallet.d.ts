...
import { IBaseCoin, Message, SignedMessage, SignedTransaction, TransactionPrebuild, VerificationOptions, TypedData, NFTTransferOptions } from '../baseCoin';
...
declare type BaseBalance = {
    balanceString: string;
    confirmedBalanceString: string;
    spendableBalanceString: string;
};
export declare type NftBalance = BaseBalance & {
    type: string;
    metadata: {
        name: string;
...
export interface WalletData {
    ...
    nfts?: {
        [contractAddressOrToken: string]: NftBalance;
    };
    unsupportedNfts?: {
        [contractAddress: string]: NftBalance;
    };
    users?: WalletUser[];
}
...
export declare type SendNFTOptions = Omit<SendManyOptions, 'recipients' | 'enableTokens' | 'tokenName' | 'txFormat' | 'receiveAddress'>;
export declare type SendNFTResult = {
