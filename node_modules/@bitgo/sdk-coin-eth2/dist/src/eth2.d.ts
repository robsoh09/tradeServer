...
import { BaseCoin, BitGoBase, HalfSignedAccountTransaction as BaseHalfSignedTransaction, IBlsKeyPair, ParsedTransaction, ParseTransactionOptions, SignTransactionOptions as BaseSignTransactionOptions, VerifyAddressOptions, VerifyTransactionOptions } from '@bitgo/sdk-core';
interface Recipient {
    address: string;
    amount: string;
    data?: string;
