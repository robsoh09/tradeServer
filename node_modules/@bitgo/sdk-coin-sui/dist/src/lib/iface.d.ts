...
import { GasData, ProgrammableTransaction, CallArg, SuiAddress, SuiObjectRef, TransactionExpiration } from './mystenlab/types';
...
export interface TxData {
    ...
    gasData: GasData;
    kind: {
        ProgrammableTransaction: TransferProgrammableTransaction | StakingProgrammableTransaction | CustomProgrammableTransaction;
    };
}
export declare type TransferProgrammableTransaction = ProgrammableTransaction | {
    inputs: CallArg[] | TransactionBlockInput[];
    transactions: TransactionType[];
};
export declare type StakingProgrammableTransaction = ProgrammableTransaction | {
    inputs: CallArg[] | TransactionBlockInput[];
    transactions: TransactionType[];
};
export declare type UnstakingProgrammableTransaction = ProgrammableTransaction | {
    inputs: CallArg[] | TransactionBlockInput[];
    transactions: TransactionType[];
};
export declare type CustomProgrammableTransaction = ProgrammableTransaction | {
    inputs: CallArg[] | TransactionBlockInput[];
    transactions: TransactionType[];
};
export interface SuiTransaction<T = TransferProgrammableTransaction | StakingProgrammableTransaction | CustomProgrammableTransaction> {
    id?: string;
