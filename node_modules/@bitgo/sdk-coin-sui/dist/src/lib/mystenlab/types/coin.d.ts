...
export declare type PaginatedCoins = Infer<typeof PaginatedCoins>;
...
export declare type CoinBalance = Infer<typeof CoinBalance>;
export declare const CoinSupply: import("superstruct").Struct<{
    value: number;
}, {
    value: import("superstruct").Struct<number, null>;
}>;
export declare type CoinSupply = Infer<typeof CoinSupply>;
