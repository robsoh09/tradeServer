...
export declare class FederatedAttestationsWrapper extends BaseWrapper<FederatedAttestations> {
     ...
     * @dev Throws if an attestation with the same (identifier, issuer, account) already exists
     */
    registerAttestation: (identifier: string, issuer: Address, account: Address, signer: Address, issuedOn: number, v: number | string, r: string | number[], s: string | number[]) => CeloTransactionObject<void>;
    /**
