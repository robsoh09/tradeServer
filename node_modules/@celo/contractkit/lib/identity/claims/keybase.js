...
var proofFileName = function (address) { return "verify-".concat(address, ".json"); };
exports.proofFileName = proofFileName;
var targetURL = function (username, address) {
    return "https://".concat(username, ".keybase.pub/").concat(exports.keybaseFilePathToProof).concat((0, exports.proofFileName)(address));
};
...
function verifyKeybaseClaim(kit, claim, signer) {
    return __awaiter(this, void 0, void 0, function () {
        var resp, jsonResp, parsedClaim, hasValidSignature, _a, _b, parsedKeybaseClaim, error_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 5, , 6]);
                    return [4 /*yield*/, (0, cross_fetch_1.default)((0, exports.targetURL)(claim.username, signer))];
                case 1:
                    resp = _c.sent();
                    if (!resp.ok) {
                        return [2 /*return*/, "Proof of ownership could not be retrieved at ".concat((0, exports.targetURL)(claim.username, signer), ", request yielded ").concat(resp.status, " status code")];
                    }
                ...
                case 2:
                    ...
                    _b = (_a = metadata_1.IdentityMetadataWrapper).verifySignerForAddress;
                    return [4 /*yield*/, kit.contracts.getAccounts()];
                case 3: return [4 /*yield*/, _b.apply(_a, [_c.sent(), (0, claim_1.hashOfClaim)(parsedClaim.right.claim),
                        parsedClaim.right.signature,
                        signer])];
                case 4:
                    hasValidSignature = _c.sent();
...
var createKeybaseClaim = function (username) { return ({
    username: username,
